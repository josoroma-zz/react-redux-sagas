...
/**
 * ActionCreators are functions that returns a plain action object.
 *
 * They can be used in a component by returning bindActionCreators() function
 * provided by redux in mapDispatchToProps().
 */
